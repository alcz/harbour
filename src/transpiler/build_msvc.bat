...
set "T=src\transpiler"
set "SRC=%T%\cmdcheck.c %T%\complex.c %T%\expropta.c %T%\genhb.c %T%\gencsharp.c %T%\gencs0.c"
...
cl.exe /nologo /c /W1 /O2 /DHB_TRANSPILER /D_CRT_SECURE_NO_WARNINGS ^
    /DHB_REFTAB_PATH=\"..\\hbrefs.tab\" /DHB_FUNCTAB_PATH=\"..\\hbfuncs.tab\" ^
